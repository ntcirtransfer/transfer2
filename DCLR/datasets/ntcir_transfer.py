...
def _init():
    ...
    # Transfer-2
    DL_DOCS_TRAIN2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-1/clir/ntc1-e1.utf8.jsonl')
    DL_QUERIES_TRAIN2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-1/topics/topic0001-0083.utf8.jsonl')
    DL_QRELS_TRAIN2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-1/clir/rel2_ntc1-e1_0001-0083.utf8.tsv')

    DL_DOCS_VALID2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-2/e-docs/ntc12-e1gk.utf8.mod.jsonl')
    DL_QUERIES_VALID2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-2/topics/topic-j0101-0149.utf8.jsonl')
    DL_QRELS_VALID2 = ir_datasets.util.LocalDownload(TC_ROOT + '/testcollections/ntcir/NTCIR-2/rels/rel2_ntc2-je2_0101-0149.nc.utf8.tsv')
    ...
    subsets['2/train'] = ir_datasets.Dataset(
        JsonlDocs(ir_datasets.util.Cache(DL_DOCS_TRAIN2, base_path/'ntc1-e1.utf8.jsonl')),
        JsonlQueries(ir_datasets.util.Cache(DL_QUERIES_TRAIN2, base_path/'topic0001-0083.utf8.jsonl')),
        TrecQrels(ir_datasets.util.Cache(DL_QRELS_TRAIN2, base_path/'rel2_ntc1-e1_0001-0083.utf8.tsv'), QREL_DEFS_TRAIN),
    )
    subsets['2/valid'] = ir_datasets.Dataset(
        JsonlDocs(ir_datasets.util.Cache(DL_DOCS_VALID2, base_path/'ntc12-e1gk.utf8.mod.jsonl')),
        JsonlQueries(ir_datasets.util.Cache(DL_QUERIES_VALID2, base_path/'topic-j0101-0149.utf8.jsonl')),
        TrecQrels(ir_datasets.util.Cache(DL_QRELS_VALID2, base_path/'rel2_ntc2-je2_0101-0149.nc.utf8.tsv'), QREL_DEFS_TRAIN),
    )
